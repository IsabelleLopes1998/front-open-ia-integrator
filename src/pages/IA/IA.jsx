  ...
  return (
    <MainLayout>
      <div className="lg:ml-64 min-h-screen flex flex-col">
        {/* Header do Chat */}
        <div className="bg-[#0b0b0b] border-b border-[#333] px-4 py-6">
        ...
        {/* Área de Mensagens */}
        <div className="flex-1 overflow-y-auto bg-[#0f0f0f] min-h-0">
        ...
        {/* Input Area */}
        <div className="bg-[#0b0b0b] border-t border-[#333] px-4 py-6">
          <div className="max-w-4xl mx-auto">
            <div className="flex gap-3">
              <textarea
